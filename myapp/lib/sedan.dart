...
class SedanBookingPage extends StatefulWidget {
  final String carType;
  final String category;

  SedanBookingPage({required this.carType, required this.category});

  @override
  _SedanBookingPageState createState() => _SedanBookingPageState();
}

class _SedanBookingPageState extends State<SedanBookingPage> {
  final _pickupController = TextEditingController();
  final _dropoffController = TextEditingController();
  String? _selectedCar;
  List<String> availableCars = ["Swift", "Polo", "Indigo", "Etios", "Ciaz","City"];
  int _bookingId = 1;
  ...
  Future<void> _saveToExcel(String pickup, String dropoff, String car, String status) async {
    ...
    if (statusPermission.isGranted) {
      ...
      String filePath = "${directory.path}/MSEDAN_Bookings.xlsx";
