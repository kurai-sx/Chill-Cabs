...
class SuvBookingPage extends StatefulWidget {
  final String carType;
  final String category;

  SuvBookingPage({required this.carType, required this.category});

  @override
  _SuvBookingPageState createState() => _SuvBookingPageState();
}

class _SuvBookingPageState extends State<SuvBookingPage> {
  final _pickupController = TextEditingController();
  final _dropoffController = TextEditingController();
  String? _selectedCar;
  List<String> availableCars = ["G Wagon", "Fortuner", "Safari", "Thar", "Scorpio","Isuzu"];
  int _bookingId = 1;
  ...
  Future<void> _saveToExcel(String pickup, String dropoff, String car, String status) async {
    ...
    if (statusPermission.isGranted) {
      ...
      String filePath = "${directory.path}/MSUV_Bookings.xlsx";
