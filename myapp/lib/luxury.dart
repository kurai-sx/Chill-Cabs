...
class LuxuryBookingPage extends StatefulWidget {
  ...
  LuxuryBookingPage({required this.carType, required this.category});
...
class _LuxuryBookingPageState extends State<LuxuryBookingPage> {
  ...
  String? _selectedCar;
  List<String> availableCars = ["Rolls Royce", "Maybach", "GT-R", "Limosuine", "Lexus","Mercedes"];
  int _bookingId = 1;
  ...
  Future<void> _saveToExcel(String pickup, String dropoff, String car, String status) async {
    ...
    if (statusPermission.isGranted) {
      ...
      String filePath = "${directory.path}/MLUX_Bookings.xlsx";
